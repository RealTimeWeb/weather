...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname weather-test) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ())))
(require 2htdp/image)
...
(weather-wind-speed (report-weather report-online-valid))
(error "test")
